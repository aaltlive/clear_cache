...
ПРОВЕРИТЬ, ЧТО ИЗ-ЗА НИХ НЕ ЗАСТРЯНУТ ССЫЛКИ 
! [Для вк возврат сделан в нескольких случаях] - eсли запрос не удался, то вернуть ссылку в очередь. Делать так ограниченное кол-во раз
